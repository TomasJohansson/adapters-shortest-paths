 ...
 */
public class PathFinderFactoryReneArgentoGenerics<F extends PathFinderGenerics<P, E,V,W> , P extends PathGenerics<E, V, W> ,  E extends EdgeGenerics<V, W> , V extends Vertex , W extends Weight> 
	...
	implements PathFinderFactoryGenerics<F,P,E,V,W> 
{
	public F createPathFinder(
		...
		return (F) new PathFinderReneArgentoGenerics<P, E, V, W>(
			graph 
		);
	}	
}