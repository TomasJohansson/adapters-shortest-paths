 ...
 */
public final class PathFinderFactoryJgrapht<T extends Edge>  extends PathFinderFactoryBase<T> implements PathFinderFactory<T> {

	public PathFinder<T> createPathFinder(
		final Graph<T> graph, 
		final GraphEdgesValidationDesired graphEdgesValidationDesired
	) {
		return new PathFinderJgrapht<T>(
			graph, 
