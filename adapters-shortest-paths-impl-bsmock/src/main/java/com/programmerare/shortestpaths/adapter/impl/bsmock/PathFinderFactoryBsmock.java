 ...
 */
public class PathFinderFactoryBsmock<F extends PathFinder<E,V,W> , E extends Edge<V, W> , V extends Vertex , W extends Weight> 
	...
	implements PathFinderFactory<F , E , V  , W > 
{
	public F createPathFinder(
		...
		final PathFinder<E, V, W> pathFinderBsmock = new PathFinderBsmock<E, V, W>(
			graph, 
